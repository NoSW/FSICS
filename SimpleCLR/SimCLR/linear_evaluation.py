...
if __name__ == "__main__":
    ...
    if args.dataset == "STL10":
        ...
        root = "..\\..\\dataset\\tiered_imagenet"
        train_dataset = FSDataset(
                annotations_file ="../../dataset/tiered_imagenet/train.csv",
                img_dir = os.path.join(root, "train"),
                transform=TransformsSimCLR(size=args.image_size).test_transform,
                target_transform=None
            )
        test_dataset = FSDataset(
                annotations_file = "../../dataset/tiered_imagenet/test.csv",
        ...
        train_dataset = FSDataset(
                annotations_file ="../../dataset/mini-imagenet/train.csv",
                img_dir = os.path.join(root, "train"),
                transform=TransformsSimCLR(size=args.image_size).test_transform,
                target_transform=None
            )
        test_dataset = FSDataset(
                annotations_file = "../../dataset/mini-imagenet/test.csv",
                img_dir = os.path.join(root, "test"),
                transform=TransformsSimCLR(size=args.image_size).test_transform,
                target_transform=None
                )
